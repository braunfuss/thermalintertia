%This is the funtion for only Soilmoisture influence
...
% Here [Soil density (g/cm^3) Soilmoisture (%) Albedo]
lb = [1.8 0.1 0.1 ];
ub = [3 100 1];
...
X0 = [2 5 0.5];   % Starting point for each input parameter, if no a priori knowledge just use the middle of the upper and lower boundaries
...
ObjectiveFunction = @(A) parameterized_objectiveII(A,sol,lat,image1,image2,sv(l),mode);
